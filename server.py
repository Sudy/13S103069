...
def main_server():
	...
	listen_tcp_fd.settimeout(timeout)
	...
	listen_udp_fd.settimeout(timeout)
	...
	while True:
		...
		if listen_http_fd in rfds_list:
			...
			http_thread = HTTPThread(http_client_fd)
			http_thread.start()
